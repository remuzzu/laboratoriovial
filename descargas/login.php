...
descarga_login.php PORQUE LLAMABA A UN header 
                ...
                <div class="col-md-6 text-center">
                    ...
                    <form id="form_login" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" autocomplete="off"> 
                        ...
                        <div style="margin-bottom: 25px" class="input-group">
                            ...
                            <input id="usuario" type="text" class="form-control" name="usuario" value="" data-rule="email" placeholder="email (usuario)" required>                                        
                        </div>
                        ...
                        <div style="border-top: 1px solid#888;" >
                            ¿No te has registrado todavia? <a href="descarga_registro.php">Registrarse aquí</a>
                        </div>

                        <div id="register-link" class="text-center">
                            <p class="change_link">
                                <a href="descarga_recupera.php">¿Se te olvidó la contraseña?</a>
                            </p>
                        </div>
                    </form>
